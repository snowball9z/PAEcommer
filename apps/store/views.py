...
def ProductDetail(request, category_slug, slug):
    ...
    if request.method == 'POST' and request.user.is_authenticated:
        ...
        return redirect('store:productDetail', category_slug=category_slug, slug=slug)
    ...
    if product.parent:
        return redirect('store:productDetail', category_slug=category_slug, slug=product.parent.slug)
